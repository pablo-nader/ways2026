...
namespace Ways.Infrastructure.Persistencia.Migraciones
{
    ...
    [Migration("20260920105427_ReservaDeNumeracion")]
    partial class ReservaDeNumeracion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "ambiente_fiscal", new[] { "homologacion", "produccion" });
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "estado_orden_compra", new[] { "anulada", "borrador", "cerrada", "enviada", "recibida_parcial" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "estado_presupuesto", new[] { "anulado", "borrador", "convertido", "enviado" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "estado_remito", new[] { "anulado", "borrador", "emitido", "facturado" });
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "tipo_movimiento_cc_proveedor", new[] { "ajuste", "apertura", "compra", "pago" });
            ...
            modelBuilder.Entity("Ways.Domain.Compras.ComprobanteCompra", b =>
                {
                    ...
                    b.HasIndex("IdOrdenCompra", "IdTenant")
            ...
            modelBuilder.Entity("Ways.Domain.Compras.ItemOrdenCompra", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<decimal?>("CostoUnitarioEstimado")
                        .HasColumnType("numeric(14,4)")
                        .HasColumnName("costo_unitario_estimado");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_items_orden_compra");

                    b.HasIndex("IdTenant")
                        .HasDatabaseName("ix_items_orden_compra_tenant");

                    b.HasIndex("IdArticulo", "IdTenant")
                        .HasDatabaseName("ix_items_orden_compra_articulo");

                    b.HasIndex("IdOrdenCompra", "IdTenant")
                        .HasDatabaseName("ix_items_orden_compra_orden_compra");

                    b.HasIndex("IdOrdenCompra", "Orden")
                        .IsUnique()
                        .HasDatabaseName("ux_items_orden_compra_orden");

                    b.ToTable("items_orden_compra", null, t =>
                        {
                            t.HasCheckConstraint("ck_items_orden_compra_cantidad_positiva", "cantidad_pedida > 0");

                            t.HasCheckConstraint("ck_items_orden_compra_costo_no_negativo", "costo_unitario_estimado IS NULL OR costo_unitario_estimado >= 0");
                        });
                });

            modelBuilder.Entity("Ways.Domain.Compras.OrdenCompra", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<EstadoOrdenCompra>("Estado")
                    ...
                    b.HasIndex("IdEmpleado")
                        .HasDatabaseName("ix_ordenes_compra_empleado");

                    b.HasIndex("IdEmpleadoCierre")
                        .HasDatabaseName("ix_ordenes_compra_empleado_cierre");

                    b.HasIndex("IdTenant")
                        .HasDatabaseName("ix_ordenes_compra_tenant");

                    b.HasIndex("IdProveedor", "IdTenant")
                        .HasDatabaseName("ix_ordenes_compra_proveedor");

                    b.HasIndex("IdPuntoVenta", "IdTenant", "FechaEmision")
                        .HasDatabaseName("ix_ordenes_compra_punto_venta_fecha");

                    b.HasIndex("IdTenant", "IdPuntoVenta", "Numero")
                        .IsUnique()
                    ...
                    b.ToTable("ordenes_compra", null, t =>
                        {
                            t.HasCheckConstraint("ck_ordenes_compra_cierre", "((fecha_cierre IS NULL) = (estado <> 'cerrada')) AND (id_empleado_cierre IS NULL OR fecha_cierre IS NOT NULL)");

                            t.HasCheckConstraint("ck_ordenes_compra_envio_completo", "((numero IS NULL) = (fecha_envio IS NULL)) AND (estado IN ('borrador','anulada') OR numero IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("Ways.Domain.CuentaCorriente.MovimientoCuentaCorrienteProveedor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<TipoMovimientoCcProveedor>("Tipo")
                        .HasColumnType("tipo_movimiento_cc_proveedor")
                        .HasColumnName("tipo");

                    b.HasKey("Id")
                        .HasName("pk_movimientos_cuenta_corriente_proveedor");

                    b.HasIndex("IdEmpleado")
                        .HasDatabaseName("ix_movimientos_cuenta_corriente_proveedor_empleado");

                    b.HasIndex("IdTenant")
                        .HasDatabaseName("ix_movimientos_cuenta_corriente_proveedor_tenant");

                    b.HasIndex("IdComprobanteCompra", "IdTenant")
                        .HasDatabaseName("ix_movimientos_cuenta_corriente_proveedor_comprobante_compra");

                    b.HasIndex("IdGasto", "IdTenant")
                    ...
                    b.HasIndex("IdProveedor", "IdTenant", "Fecha")
                        .HasDatabaseName("ix_movimientos_cuenta_corriente_proveedor_proveedor_fecha");

                    b.ToTable("movimientos_cuenta_corriente_proveedor", null, t =>
                        {
                            t.HasCheckConstraint("ck_movimientos_cuenta_corriente_proveedor_apertura", "(tipo = 'apertura' AND id_punto_venta IS NULL AND id_empleado IS NULL) OR (tipo <> 'apertura' AND id_punto_venta IS NOT NULL AND id_empleado IS NOT NULL)");
                        });
                });

            modelBuilder.Entity("Ways.Domain.Dispositivos.Dispositivo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("IdUsuarioAlta")
                        .HasDatabaseName("ix_dispositivos_usuario_alta");

                    b.HasIndex("TokenHash")
                        .IsUnique()
                        .HasDatabaseName("ux_dispositivos_token_hash");
            ...
            modelBuilder.Entity("Ways.Domain.Fiscal.CertificadoFiscal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<AmbienteFiscal>("Ambiente")
                    ...
                    b.Property<string>("CertificadoPem")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("certificado_pem");

                    b.Property<byte[]>("ClavePrivadaCifrada")
                        .IsRequired()
                        .HasColumnType("bytea")
                        .HasColumnName("clave_privada_cifrada");
                    ...
                    b.Property<string>("CuitTitular")
                        ...
                        .HasColumnName("cuit_titular");

                    b.Property<DateTimeOffset?>("DeletedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("deleted_at");

                    b.Property<string>("HuellaSha256")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("huella_sha256");

                    b.Property<string>("IdClaveMaestra")
                        .IsRequired()
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)")
                        .HasColumnName("id_clave_maestra");
                    ...
                    b.Property<byte[]>("TagAutenticacion")
                        .IsRequired()
                        .HasColumnType("bytea")
                        .HasColumnName("tag_autenticacion");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_certificados_fiscales");

                    b.HasIndex("IdTenant")
                        .HasDatabaseName("ix_certificados_fiscales_tenant");

                    b.HasIndex("IdEmpresa", "IdTenant")
                        .HasDatabaseName("ix_certificados_fiscales_empresa");

                    b.HasIndex("IdTenant", "IdEmpresa", "Ambiente")
                        .IsUnique()
                        .HasDatabaseName("ux_certificados_fiscales_activo")
                        .HasFilter("activo AND deleted_at IS NULL");

                    b.ToTable("certificados_fiscales", null, t =>
                        {
                            t.HasCheckConstraint("ck_certificados_fiscales_cuit", "cuit_titular ~ '^[0-9]{11}$'");

                            t.HasCheckConstraint("ck_certificados_fiscales_material", "octet_length(nonce) = 12 AND octet_length(tag_autenticacion) = 16 AND octet_length(clave_privada_cifrada) > 0");

                            t.HasCheckConstraint("ck_certificados_fiscales_vigencia", "vigencia_hasta > vigencia_desde");
                        });
                });

            modelBuilder.Entity("Ways.Domain.Fiscal.NumeracionFiscal", b =>
                {
                    b.Property<int>("IdPuntoVenta")
                        .HasColumnType("integer")
                        .HasColumnName("id_punto_venta");
                    ...
                    b.Property<long?>("UltimoAutorizadoArca")
                        .HasColumnType("bigint")
                        .HasColumnName("ultimo_autorizado_arca");

                    b.HasKey("IdPuntoVenta", "CodigoAfip")
                        .HasName("pk_numeraciones_fiscales");

                    b.HasIndex("IdTenant")
                        .HasDatabaseName("ix_numeraciones_fiscales_tenant");

                    b.HasIndex("IdPuntoVenta", "IdTenant")
                        .HasDatabaseName("ix_numeraciones_fiscales_punto_venta");

                    b.ToTable("numeraciones_fiscales", null, t =>
                        {
                            t.HasCheckConstraint("ck_numeraciones_fiscales_rango", "proximo_numero BETWEEN 1 AND 99999999 AND (ultimo_autorizado_arca IS NULL OR ultimo_autorizado_arca BETWEEN 0 AND 99999999)");

                            t.HasCheckConstraint("ck_numeraciones_fiscales_sincronizacion", "(ultimo_autorizado_arca IS NULL) = (sincronizado_en IS NULL)");
                        });
                });
            ...
            modelBuilder.Entity("Ways.Domain.Organizacion.Empresa", b =>
                {
                    ...
                    b.HasIndex("IdCondicionFiscal")
                        .HasDatabaseName("ix_empresas_condicion_fiscal");
            ...
            modelBuilder.Entity("Ways.Domain.Organizacion.PuntoVenta", b =>
                {
                    ...
                    b.HasIndex("IdTenant", "IdEmpresa", "NumeroFiscal")
                        .IsUnique()
                        .HasDatabaseName("ux_puntos_venta_numero_fiscal")
                        .HasFilter("numero_fiscal IS NOT NULL");

                    b.ToTable("puntos_venta", null, t =>
                        {
                            t.HasCheckConstraint("ck_puntos_venta_numero_fiscal_rango", "numero_fiscal IS NULL OR (numero_fiscal BETWEEN 1 AND 99999)");
                        });
                });
            ...
            modelBuilder.Entity("Ways.Domain.Stock.MovimientoStock", b =>
                {
                    ...
                    b.HasIndex("IdRemito", "IdTenant")
                        .HasDatabaseName("ix_movimientos_stock_remito");
            ...
            modelBuilder.Entity("Ways.Domain.Ventas.ComprobanteVenta", b =>
                {
                    ...
                    b.Property<string>("ObservacionesFiscales")
                        .HasColumnType("jsonb")
                        .HasColumnName("observaciones_fiscales");

                    b.Property<ResultadoFiscal?>("ResultadoFiscal")
                        .HasColumnType("resultado_fiscal")
                        .HasColumnName("resultado_fiscal");
                    ...
                    b.HasIndex("IdPresupuestoOrigen", "IdTenant")
                        .IsUnique()
                    ...
                    b.ToTable("comprobantes_venta", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_comprobantes_venta_fiscal_coherente", "(resultado_fiscal IS NULL AND cae IS NULL AND cae_vencimiento IS NULL AND observaciones_fiscales IS NULL) OR (resultado_fiscal IS NOT NULL AND ((cae IS NULL) = (cae_vencimiento IS NULL)) AND ((resultado_fiscal IN ('aprobado','aprobado_con_observaciones')) = (cae IS NOT NULL)))");
            ...
            modelBuilder.Entity("Ways.Domain.Ventas.ItemPresupuesto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_items_presupuesto");

                    b.HasIndex("IdAlicuotaIva")
                        .HasDatabaseName("ix_items_presupuesto_alicuota_iva");

                    b.HasIndex("IdTenant")
                        .HasDatabaseName("ix_items_presupuesto_tenant");

                    b.HasIndex("IdArticulo", "IdTenant")
                        .HasDatabaseName("ix_items_presupuesto_articulo");

                    b.HasIndex("IdListaPrecio", "IdTenant")
                        .HasDatabaseName("ix_items_presupuesto_lista_precio");

                    b.HasIndex("IdOferta", "IdTenant")
                        .HasDatabaseName("ix_items_presupuesto_oferta");

                    b.HasIndex("IdPresupuesto", "IdTenant")
                        .HasDatabaseName("ix_items_presupuesto_presupuesto");

                    b.HasIndex("IdPresupuesto", "Orden")
                        .IsUnique()
                        .HasDatabaseName("ux_items_presupuesto_orden");

                    b.ToTable("items_presupuesto", null, t =>
                        {
                            t.HasCheckConstraint("ck_items_presupuesto_cantidad_positiva", "cantidad > 0");
                        });
                });

            modelBuilder.Entity("Ways.Domain.Ventas.ItemRemito", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_items_remito");

                    b.HasIndex("IdAlicuotaIva")
                        .HasDatabaseName("ix_items_remito_alicuota_iva");

                    b.HasIndex("IdTenant")
                        .HasDatabaseName("ix_items_remito_tenant");

                    b.HasIndex("IdArticulo", "IdTenant")
                        .HasDatabaseName("ix_items_remito_articulo");

                    b.HasIndex("IdListaPrecio", "IdTenant")
                        .HasDatabaseName("ix_items_remito_lista_precio");

                    b.HasIndex("IdOferta", "IdTenant")
                        .HasDatabaseName("ix_items_remito_oferta");

                    b.HasIndex("IdRemito", "IdTenant")
                        .HasDatabaseName("ix_items_remito_remito");

                    b.HasIndex("IdRemito", "Orden")
                        .IsUnique()
                        .HasDatabaseName("ux_items_remito_orden");

                    b.HasIndex("IdLote", "IdArticulo", "IdTenant")
                        .HasDatabaseName("ix_items_remito_lote");

                    b.ToTable("items_remito", null, t =>
                        {
                            t.HasCheckConstraint("ck_items_remito_cantidad_positiva", "cantidad > 0");

                            t.HasCheckConstraint("ck_items_remito_costo_no_negativo", "costo_unitario IS NULL OR costo_unitario >= 0");

                            t.HasCheckConstraint("ck_items_remito_estimado_con_costo", "NOT costo_es_estimado OR costo_unitario IS NOT NULL");
                        });
                });
            ...
            modelBuilder.Entity("Ways.Domain.Ventas.Presupuesto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<EstadoPresupuesto>("Estado")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_presupuestos");

                    b.HasAlternateKey("Id", "IdTenant")
                        .HasName("ak_presupuestos_id_presupuesto_id_tenant");

                    b.HasIndex("IdEmpleado")
                        .HasDatabaseName("ix_presupuestos_empleado");

                    b.HasIndex("IdTenant")
                        .HasDatabaseName("ix_presupuestos_tenant");

                    b.HasIndex("IdCliente", "IdTenant")
                        .HasDatabaseName("ix_presupuestos_cliente");
                    ...
                    b.ToTable("presupuestos", null, t =>
                        {
                            t.HasCheckConstraint("ck_presupuestos_envio_completo", "((numero IS NULL) = (fecha_envio IS NULL)) AND ((numero IS NULL) = (vencimiento IS NULL)) AND (estado IN ('borrador','anulado') OR numero IS NOT NULL)");
                        });
                });

            modelBuilder.Entity("Ways.Domain.Ventas.Remito", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<EstadoRemito>("Estado")
                    ...
                    b.HasIndex("IdEmpleado")
                        .HasDatabaseName("ix_remitos_empleado");

                    b.HasIndex("IdTenant")
                        .HasDatabaseName("ix_remitos_tenant");

                    b.HasIndex("IdCliente", "IdTenant")
                        .HasDatabaseName("ix_remitos_cliente");

                    b.HasIndex("IdComprobanteVenta", "IdTenant")
                        .HasDatabaseName("ix_remitos_comprobante_venta");
                    ...
                    b.ToTable("remitos", null, t =>
                        {
                            t.HasCheckConstraint("ck_remitos_facturacion", "(id_comprobante_venta IS NULL) = (estado <> 'facturado')");

                            t.HasCheckConstraint("ck_remitos_salida_completa", "((numero IS NULL) = (fecha_salida IS NULL)) AND (estado IN ('borrador','anulado') OR numero IS NOT NULL)");
                        });
                });

            modelBuilder.Entity("Ways.Domain.Ventas.ReservaNumeracion", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<DateTimeOffset?>("AbandonadaAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("abandonada_at");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_reservas_numeracion");

                    b.HasIndex("IdTenant")
                        .HasDatabaseName("ix_reservas_numeracion_tenant");

                    b.HasIndex("IdDispositivo", "IdTenant")
                        .HasDatabaseName("ix_reservas_numeracion_dispositivo");

                    b.HasIndex("IdPuntoVenta", "IdTenant")
                        .HasDatabaseName("ix_reservas_numeracion_punto_venta");

                    b.HasIndex("IdTenant", "IdPuntoVenta", "TipoComprobante", "IdDispositivo")
                        .IsUnique()
                        .HasDatabaseName("ux_reservas_numeracion_dispositivo_activo")
                        .HasFilter("abandonada_at IS NULL");

                    b.ToTable("reservas_numeracion", null, t =>
                        {
            ...
            modelBuilder.Entity("Ways.Domain.Compras.ComprobanteCompra", b =>
                {
                    ...
                    b.HasOne("Ways.Domain.Compras.OrdenCompra", null)
                        .WithMany()
                        .HasForeignKey("IdOrdenCompra", "IdTenant")
                        .HasPrincipalKey("Id", "IdTenant")
                        .OnDelete(DeleteBehavior.Restrict)
            ...
            modelBuilder.Entity("Ways.Domain.CuentaCorriente.MovimientoCuentaCorrienteProveedor", b =>
                {
                    ...
                    b.HasOne("Ways.Domain.Gastos.Gasto", null)
                        .WithMany()
                        .HasForeignKey("IdGasto", "IdTenant")
                        .HasPrincipalKey("Id", "IdTenant")
                        .OnDelete(DeleteBehavior.Restrict)
            ...
            modelBuilder.Entity("Ways.Domain.Stock.MovimientoStock", b =>
                {
                    ...
                    b.HasOne("Ways.Domain.Ventas.Remito", null)
                        .WithMany()
                        .HasForeignKey("IdRemito", "IdTenant")
                        .HasPrincipalKey("Id", "IdTenant")
                        .OnDelete(DeleteBehavior.Restrict)
            ...
            modelBuilder.Entity("Ways.Domain.Ventas.ComprobanteVenta", b =>
                {
                    ...
                    b.HasOne("Ways.Domain.Ventas.Presupuesto", null)
                        .WithMany()
                        .HasForeignKey("IdPresupuestoOrigen", "IdTenant")
                        .HasPrincipalKey("Id", "IdTenant")
                        .OnDelete(DeleteBehavior.Restrict)
            ...
            modelBuilder.Entity("Ways.Domain.Ventas.ItemPresupuesto", b =>
                {
                    ...
                    b.HasOne("Ways.Domain.Ventas.Presupuesto", null)
                        .WithMany()
                        .HasForeignKey("IdPresupuesto", "IdTenant")
                        .HasPrincipalKey("Id", "IdTenant")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
            ...
            modelBuilder.Entity("Ways.Domain.Ventas.ReservaNumeracion", b =>
                {
                    ...
                    b.HasOne("Ways.Domain.Dispositivos.Dispositivo", null)
                        .WithMany()
                        .HasForeignKey("IdDispositivo", "IdTenant")
                        .HasPrincipalKey("Id", "IdTenant")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
